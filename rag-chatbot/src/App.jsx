...
function AppLayout() {
  ...
  return (
    <>
      ...
      {/* Farming background section */}
      <div className="background-container">
        <div className="background-half" style={{ backgroundImage: `url(${image1})` }}></div>
        <div className="background-half" style={{ backgroundImage: `url(${image2})` }}></div>
      </div>
